...
(if cscope-list-entry-keymap
  ...
  (define-key cscope-list-entry-keymap "G" 'cscope-find-global-definition-no-prompting)
...
(if cscope:map
  ...
  (define-key cscope:map "\C-csj" 'cscope-find-global-definition-no-prompting)
