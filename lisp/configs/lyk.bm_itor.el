;;; lyk.bm_itor.el --- iterate through bookmarks - similar to DevStudio
...
(define-key global-map [(shift f12)] 'bookmark-delete-by-line)
(define-key global-map [(control f12)] 'bookmark-set-by-line)
(define-key global-map [(f12)] 'bookmark-get-next)
(define-key global-map [(control shift f12)] 'list-bookmarks)
